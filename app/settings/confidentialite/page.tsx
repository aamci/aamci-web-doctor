...
import { HelpCircle, Shield, Database, Mail, Download, Trash2, Lock, Check, Loader2, Clock, ExternalLink } from 'lucide-react';
...
export default function ConfidentialitePage() {
  ...
  useEffect(() => {
    ...
    authedFetch('/auth/deletion-status').then(r => r.json()).then((d: any) => {
  ...
  async function handleCancelDeletion() {
    try {
      ...
      toast.success('Suppression annulée — votre compte est réactivé');
    } catch (e: unknown) {
              ...
              <div className="px-5 py-3.5">
                <div className="flex items-center justify-between mb-3">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">Supprimer définitivement votre compte</p>
                  </div>
                </div>
                {pendingDeletion ? (
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 mb-2">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <p className="text-xs font-semibold text-amber-700">Suppression programmée</p>
                    </div>
                    <p className="text-xs text-amber-600 mb-2">
                      Suppression le {new Date(pendingDeletion).toLocaleDateString('fr-FR', { day: 'numeric', month: 'long', year: 'numeric' })}
                    </p>
                ...
                <button onClick={() => router.push('/delete-account')}
                  ...
                  Page dédiée de suppression de compte
                </button>
              </div>
              <div className="flex items-center justify-between px-5 py-3.5">
                <div>
